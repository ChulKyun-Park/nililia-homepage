...
import { Briefcase, Globe, Lightbulb, Heart } from "lucide-react";
...
const benefits = [
  {
    icon: Globe,
    title: "글로벌 환경",
    description: "전 세계 50개 이상의 언어를 다루며, 다양한 문화와 소통하는 경험을 쌓을 수 있습니다.",
  },
  {
    icon: Lightbulb,
    title: "성장 기회",
    description: "AI 기술과 번역 전문성을 함께 배우며, 업계 최전선에서 커리어를 발전시킬 수 있습니다.",
  },
  {
    icon: Heart,
    title: "유연한 근무",
    description: "자율 출퇴근, 원격 근무 등 유연한 근무 환경을 제공합니다.",
  },
  {
    icon: Briefcase,
    title: "경쟁력 있는 보상",
    description: "업계 최고 수준의 급여와 복지 혜택을 제공합니다.",
  },
];
    ...
    <>
      ...
      <Section className="bg-surface">
        <SectionHeader
          ...
          title="채용 중인 포지션"
          description="현재 채용 중인 포지션이 없습니다. 아래 버튼을 눌러 입사 지원서를 보내주시면, 적합한 포지션이 열릴 때 우선 연락드리겠습니다."
        />
