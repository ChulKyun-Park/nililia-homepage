...
const whyItems = [
  {
    title: "장르별 전문 번역가 매칭",
    description: "로맨스, 판타지, 무협 등 장르에 특화된 번역가를 배정합니다. 360명+ 검증 인력 풀에서 작품에 최적화된 인력을 선별합니다.",
  },
  {
    title: "작품의 개성을 살리는 번역",
    description: "원작의 문체와 분위기를 살려 현지 독자가 자연스럽게 몰입할 수 있도록 합니다. 컨텐츠플라이S 고품질 프리미엄 등급으로 작업합니다.",
  },
  {
    title: "대량 에피소드 · 연재 일정 대응",
    description: "연재 일정에 맞춰 대량 에피소드도 납기 지연 없이 일관되게 처리합니다. 설립 이래 납기 지연 0건을 유지하고 있습니다.",
  },
  {
    title: "글로벌 플랫폼 동시 연재 지원",
    description: "다양한 국가의 플랫폼 규격에 맞춰 동시 연재를 지원합니다. 레터링 작업을 포함한 원스톱 서비스를 제공합니다.",
  },
];
