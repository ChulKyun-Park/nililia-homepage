        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-1 gap-10 py-16 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-[length:var(--font-size-footer)] leading-relaxed text-muted">
            ...
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <a
                  href="tel:070-0000-0000"
                  className="inline-flex items-center gap-1.5 rounded-lg border border-border px-4 py-2 text-xs font-semibold text-foreground transition-colors hover:bg-white"
                >
