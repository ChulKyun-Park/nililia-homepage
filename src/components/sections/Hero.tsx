...
const SERVICES = [
  ...
  { icon: "📖", title: "웹소설 · 웹툰 번역", desc: "콘텐츠 현지화", img: "/images/hero/웹소설 번역.png" },
  { icon: "🖼️", title: "웹툰 번역", desc: "만화 현지화", img: "/images/hero/웹툰 번역.jpg" },
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-12">
        <div className="relative w-full" style={{ minHeight: 420 }}>
          ...
          <div className="relative z-20 flex min-h-[420px] items-center">
            ...
            <h1 className="text-2xl font-bold leading-tight tracking-tight text-foreground sm:text-3xl break-keep">
              여러분의 콘텐츠에<br />
