 ...
 * Row1(top3, z:1): 카드5,6,7 — 작고 흐릿
 * Row2(mid2, z:2): 카드3,4 — 중간
 * Row3(bot3, z:3): 카드0,1,2 — 크고 선명
 */
const A: Slot[] = [
  { x: 30,  y: 190, w: 195, h: 225, op: 1.0,  z: 3 },
  { x: 255, y: 195, w: 195, h: 225, op: 1.0,  z: 3 },
  { x: 480, y: 188, w: 195, h: 225, op: 0.85, z: 3 },
  { x: 140, y: 75,  w: 175, h: 200, op: 0.75, z: 2 },
  { x: 380, y: 80,  w: 175, h: 200, op: 0.70, z: 2 },
  { x: 65,  y: -30, w: 145, h: 165, op: 0.45, z: 1 },
  { x: 275, y: -25, w: 145, h: 165, op: 0.50, z: 1 },
  { x: 485, y: -30, w: 145, h: 165, op: 0.40, z: 1 },
  { x: 170, y: -220, w: 145, h: 165, op: 0, z: 0 },
  { x: 390, y: -220, w: 145, h: 165, op: 0, z: 0 },
];
 ...
 */
const B: Slot[] = [
  { x: 30,  y: STAGE_H + 40, w: 195, h: 225, op: 0, z: 0 },
  { x: 255, y: STAGE_H + 40, w: 195, h: 225, op: 0, z: 0 },
  { x: 480, y: STAGE_H + 40, w: 195, h: 225, op: 0, z: 0 },
  { x: 130, y: 190, w: 195, h: 225, op: 1.0, z: 3 },
  { x: 380, y: 195, w: 195, h: 225, op: 1.0, z: 3 },
  { x: 65,  y: 75,  w: 175, h: 200, op: 0.75, z: 2 },
  { x: 280, y: 80,  w: 175, h: 200, op: 0.75, z: 2 },
  { x: 490, y: 75,  w: 175, h: 200, op: 0.65, z: 2 },
  { x: 170, y: -30, w: 145, h: 165, op: 0.45, z: 1 },
  { x: 390, y: -25, w: 145, h: 165, op: 0.50, z: 1 },
];
...
const C: Slot[] = [
  ...
  { x: 275, y: -25,  w: 145, h: 165, op: 0.50, z: 1 },
  { x: 485, y: -30,  w: 145, h: 165, op: 0.40, z: 1 },
  { x: 130, y: STAGE_H + 40, w: 195, h: 225, op: 0, z: 0 },
  { x: 380, y: STAGE_H + 40, w: 195, h: 225, op: 0, z: 0 },
  { x: 30,  y: 190, w: 195, h: 225, op: 1.0,  z: 3 },
  { x: 255, y: 195, w: 195, h: 225, op: 1.0,  z: 3 },
  { x: 480, y: 188, w: 195, h: 225, op: 0.85, z: 3 },
  { x: 140, y: 75,  w: 175, h: 200, op: 0.75, z: 2 },
